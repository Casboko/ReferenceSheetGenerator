...
const REMIX_IDEAS = [
    "to generate different expressions.",
    "to create turnarounds for 3D modeling.",
    "to design different outfits for your character.",
    "to create a storyboard for a comic.",
    "to visualize your character in different art styles.",
